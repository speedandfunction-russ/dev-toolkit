// Package server is used to store composition extensions for gRPC service servers only
package server
...
// Once doesn't allow calling certain method while previous call is running
